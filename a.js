...
System.register('fruits.js', ['npm:jquery@3.1.1.js'], function (_export) {
	'use strict';
	...
	return {
		setters: [function (_npmJquery311Js) {
			$ = _npmJquery311Js['default'];
		}],
		execute: function () {}
	};
});
System.register('main.js', ['fruits.js'], function (_export) {
  'use strict';

  var booth;
  return {
    setters: [function (_fruitsJs) {
      booth = _fruitsJs.booth;
    }],
    execute: function () {
